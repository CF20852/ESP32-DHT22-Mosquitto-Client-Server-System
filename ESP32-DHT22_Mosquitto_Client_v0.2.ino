...
// MQTT Topics
const char* topic_temperature = "hangar/enviro_sensors/temperature";
const char* topic_humidity = "hangar/enviro_sensors/humidity";
const char* topic_dewpoint = "hangar/enviro_sensors/dewpoint";
const char* topic_status = "hangar/enviro_sensors/status";
...
const long interval = 300000;  // Send data every 300 seconds
 ...
 * Publishes data to hangar/enviro_sensors/ topic
...
void publishSensorData() {
  ...
  client.publish("hangar/enviro_sensors/", jsonString.c_str());
